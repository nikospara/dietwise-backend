...
public class RoleOrTechniqueEntity {
	...
	@OneToMany(mappedBy = "roleOrTechnique", fetch = LAZY)
	private Set<RoleOrTechniqueTranslationEntity> translations;
	...
	public Set<RoleOrTechniqueTranslationEntity> getTranslations() {
		return translations;
	}

	public void setTranslations(Set<RoleOrTechniqueTranslationEntity> translations) {
