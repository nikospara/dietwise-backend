...
public class AlternativeIngredientSeasonalityEntityId implements Serializable {
	private UUID alternativeIngredient;
	private String countryCode2;

	public AlternativeIngredientSeasonalityEntityId() {
	}

	public AlternativeIngredientSeasonalityEntityId(UUID alternativeIngredient, Country country) {
	...
	public boolean equals(Object o) {
		if (!(o instanceof AlternativeIngredientSeasonalityEntityId that)) return false;
