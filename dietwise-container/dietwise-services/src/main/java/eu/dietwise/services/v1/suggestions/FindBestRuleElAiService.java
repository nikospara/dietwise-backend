...
@RegisterAiService(
		modelName = "findBestRuleEl",
		chatMemoryProviderSupplier = RegisterAiService.NoChatMemoryProviderSupplier.class
)
@RequestScoped
public interface FindBestRuleElAiService {
	@SystemMessage(fromResource = "eu/dietwise/services/v1/ai/el/findBestRule-system.md")
	@UserMessage(fromResource = "eu/dietwise/services/v1/ai/el/findBestRule-user.md")
