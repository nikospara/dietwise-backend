...
public interface TriggerIngredientMatcherElAiService {
	@SystemMessage(fromResource = "eu/dietwise/services/v1/ai/el/triggerIngredient-system.md")
	@UserMessage(fromResource = "eu/dietwise/services/v1/ai/el/triggerIngredient-user.md")
