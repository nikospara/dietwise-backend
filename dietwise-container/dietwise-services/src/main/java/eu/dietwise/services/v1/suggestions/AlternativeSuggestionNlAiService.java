...
public interface AlternativeSuggestionNlAiService {
	@SystemMessage(fromResource = "eu/dietwise/services/v1/ai/nl/suggestAlternatives-system.md")
	@UserMessage(fromResource = "eu/dietwise/services/v1/ai/nl/suggestAlternatives-user.md")
