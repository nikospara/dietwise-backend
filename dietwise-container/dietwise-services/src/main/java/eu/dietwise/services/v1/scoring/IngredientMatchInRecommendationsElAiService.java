...
public interface IngredientMatchInRecommendationsElAiService {
	@SystemMessage(fromResource = "eu/dietwise/services/v1/ai/el/ingredientMatchInRecommendations-system.md")
	@UserMessage(fromResource = "eu/dietwise/services/v1/ai/el/ingredientMatchInRecommendations-user.md")
