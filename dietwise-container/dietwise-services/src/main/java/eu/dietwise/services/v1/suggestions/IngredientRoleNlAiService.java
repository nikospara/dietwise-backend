...
public interface IngredientRoleNlAiService {
	@SystemMessage(fromResource = "eu/dietwise/services/v1/ai/nl/roleOrTechnique-system.md")
	@UserMessage(fromResource = "eu/dietwise/services/v1/ai/nl/roleOrTechnique-user.md")
